...
class SIPProviderController extends AdminController
{
    ...
    public function data()
    {
        ...
        $dd = Datatables::of($providers)
            ...
            ->addColumn('actions', '<a href="{{{ url(\'admin/provider/\' . $id . \'/edit\' ) }}}" class="btn btn-success btn-sm iframe" ><span class="glyphicon glyphicon-pencil"></span>  {{ trans("admin/modal.edit") }}</a>
