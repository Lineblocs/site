...
class SIPTrunkController extends AdminController
{
    ...
    private function transformFormInput($input)
    ...
    public function data()
    {
        ...
        $dd = Datatables::of($trunks)
            ...
            ->addColumn('actions', '<a href="{{{ url(\'admin/trunk/\' . $id . \'/edit\' ) }}}" class="btn btn-success btn-sm iframe" ><span class="glyphicon glyphicon-pencil"></span>  {{ trans("admin/modal.edit") }}</a>
