...
final class DIDNumberTransformer extends TransformerAbstract {
    ...
    {
        $map = array(
          DIDNumberAvailability::READY_TO_USE => "Ready To Use",
          DIDNumberAvailability::PROVISIONING => "Provisioning",
          DIDNumberAvailability::UNAVAILABLE => "Unavailable",
          DIDNumberAvailability::PENDING_IN_REVIEW => "Pending In Review"
        );
