                                                ...
                                                <td class="pad"
                                                    ...
                                                    <div
                                                        ...
                                                        <p style="margin: 0; word-break: break-word;">
                                                            <span>
                                                                <h5 style="font-size: 28px;">Plan discontinuation notice.</h5>
                                                                <p>Your current plan ({{ $currentPlan->nice_name }}) is being discontinued and you are being moved to the new plan ({{ $newPlan->nice_name }}).</p>
                                                        </p>
                                                        </span>
                                                        </p>
