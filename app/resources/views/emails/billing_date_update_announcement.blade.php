                                                ...
                                                <td class="pad"
                                                    ...
                                                    <div
                                                        ...
                                                        <p style="margin: 0; word-break: break-word;">
                                                            <span>
                                                                <h5 style="font-size: 28px; margin-bottom: 15px;">Your workspace billing schedule has been updated,</h5>
                                                            </span>
                                                        </p>
                                                        <p style="margin: 0 0 15px 0; word-break: break-word;">
                                                            Hello,
                                                        </p>
                                                        <p style="margin: 0 0 15px 0; word-break: break-word;">
                                                            We have updated the billing schedule for your workspace (ID: <strong>{{ $workspace_id }}</strong>). Your next billing date is now scheduled for <strong>{{ $next_billing_date }}</strong>.
                                                        </p>
                                                        <p style="margin: 0; word-break: break-word;">
