                                                ...
                                                <td class="pad"
                                                    ...
                                                    <div
                                                        ...
                                                        <p style="margin: 0; word-break: break-word;">
                                                            <span>
                                                                To reset your password, complete this form: <a
                                                                    href="{{ \App\Helpers\MainHelper::createPortalLink('#/reset?token=' . $token } }}">Click
                                                                    Here</a>
                                                                <br>
                                                <td align="left" valign="top"
                                                    style="font-family:'Roboto', Arial, Helvetica, sans-serif; font-size:14px;line-height:23px;color:#252f5a; text-align: left;">
                                                    This link will expire in {{ config('auth.reminder.expire', 60) }}
                                                    minutes.
                                                </td>
                                                </span>
                                                </p>
