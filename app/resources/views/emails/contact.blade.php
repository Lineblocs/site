                            ...
                            <tbody>
                                <tr>
                                    <td style="padding:20px 22px; border-bottom:1px solid #e5eaf0;">
                                        <p style="font-family:Roboto, Arial, sans-serif; color:#395373; font-size:16px; line-height:24px; font-weight:bold; margin:0;">New contact inquiry</p>
                                        <p style="font-family:Roboto, Arial, sans-serif; color:#667085; font-size:13px; line-height:20px; margin:4px 0 0 0;">A visitor submitted the contact form.</p>
                                    </td>
                                </tr>
                                <tr>
