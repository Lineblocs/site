                    ...
                    <tr>
                        ...
                        <td class="mobilespacer2">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="left" valign="top" style="font-family:Roboto, Arial, sans-serif;font-size:28px;line-height:36px;color:#0a1247;font-weight: bold; text-align: left;">Hello {{$workspaceUser->first_name}} {{$workspaceUser->last_name}}, your account has been deactivated
                                    </td>
                                </tr>
                                <tr>
...
Your account in workspace {{$workspace->name}} has been deactivated. If you believe this was done in error, please contact your workspace administrator.<br /><br />
                                    </td>
                                </tr>  
                                 <tr>
