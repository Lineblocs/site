                                                ...
                                                <td class="pad"
                                                    ...
                                                    <div
                                                        ...
                                                        <p style="margin: 0; word-break: break-word;">
                                                            <span>
                                                                <h5 style="font-size: 28px;">Billing Payment Failed</h5>
                                                        </span>
                                                        </p>
                                                        <p style="margin: 0; word-break: break-word;">
                                                            Dear {{ $user->name }},
                                                        ...
                                                        <p style="margin: 0; word-break: break-word; margin-top: 15px;">
                                                            We were unable to process your recent billing payment for your subscription. Please review the details below and update your payment method.
                                                        </p>
                                                        <p style="margin: 0; word-break: break-word; margin-top: 15px;">
                                                        ...
                                                        <p style="margin: 0; word-break: break-word; margin-top: 15px;">
                                                            Please log in to your account and update your billing information to avoid service interruption.
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
