                                                ...
                                                <td class="pad"
                                                    ...
                                                    <div
                                                        ...
                                                        <p style="margin: 0; word-break: break-word;">
                                                            <span>
                                                                <h5 style="font-size: 28px;">Payment Receipt</h5>
                                                        </span>
                                                        </p>
                                                        <p style="margin: 0; word-break: break-word;">
                                                            Dear {{ $user->name }},
                                                        ...
                                                        <p style="margin: 0; word-break: break-word; margin-top: 15px;">
                                                            Thank you for your payment! Here is a summary of your recent transaction.
                                                        </p>
                                                        <p style="margin: 0; word-break: break-word; margin-top: 15px;">
                                                            <strong>Receipt ID:</strong> {{ $run_id }}<br>
                                                        ...
                                                        <p style="margin: 0; word-break: break-word; margin-top: 15px;">
                                                            Your subscription is active and your service will continue uninterrupted.
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
