                                ...
                                <tr>
                                    <td align="left" valign="top" style="font-family:'Roboto', Arial, Helvetica, sans-serif; font-size:14px;line-height:23px;color:#252f5a; text-align: center;">
                                        <div>
                                            ...
                                            <p>We are emailing you to let you know that your port request for number {{$port->number}} has been received. You will be updated about this port request when we submit it to your provider.</p>
                                            <br>
                                            <br>
                                        </div>
                                    </td>
