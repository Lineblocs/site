                                            ...
                                            <tr>
                                                <td class="pad"
                                                    ...
                                                    <div
                                                        ...
                                                        @if ($auto_topup_enabled && $was_topped_up)
                                                            <p style="margin: 0; word-break: break-word;">
                                                                <span>
                                                                    <h5 style="font-size: 28px;">Your workspace balance has been automatically topped up.</h5>
                                                            </p>
                                                            </span>
                                                            </p>
                                                            <p style="margin: 0; word-break: break-word;">
                                                                Your account has been automatically credited with <strong>${{ number_format($topup_amount, 2) }}</strong>.
                                                            </p>
                                                            <p style="margin: 0; word-break: break-word;">
                                                                Current Balance: <strong>${{ number_format($current_balance, 2) }}</strong>
                                                            </p>
                                                        @else
                                                            <p style="margin: 0; word-break: break-word;">
                                                                <span>
                                                                    <h5 style="font-size: 28px;">Your workspace balance is low and needs to be topped up.</h5>
                                                            </p>
                                                            </span>
                                                            </p>
                                                            <p style="margin: 0; word-break: break-word;">
                                                                Current Balance: <strong>${{ number_format($current_balance, 2) }}</strong><br>
                                                                Threshold: <strong>${{ number_format($threshold, 2) }}</strong>
                                                            </p>
