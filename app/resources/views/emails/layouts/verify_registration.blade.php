...
.showMobile, .showMobile img { display: none !important; }
  ...
  <body style="margin:0; padding:0; mso-line-height-rule:exactly;" bgcolor="#f5f8fa">
    ...
    <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
          <table class="MainContainer" align="center" width="600" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto; max-width:600px; background:#f5f8fa;">
            <tr>
              <td valign="top">
                              ...
                              <tr>
                                <td>
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      <td valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f5f8fa" style="">
                                          <tr>
                                              ...
                                              <table width="100%" class="wrap" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td valign="middle" align="center" style="">
                                                    <a href="{{\App\Helpers\MainHelper::createUrl()}}" target="_blan{{\Config::get("app.url").'/email-images/'}}logo.pngk">
                                                      <img src="" alt="" title="" width="160" height="" style="display:block;" border="0" />
                                                    </a>
                                                  </td>
                                                </tr>
                                              </table>
                              ...
                              <tr>
                                ...
                                <td class="mobilespacer2">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      <td valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="SubContainer" bgcolor="#395373">
                                          <tr>
                                            <td>
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                ...
                                                <tr>
                                                  <td align="left" valign="top" style="font-family:Roboto, Arial, sans-serif;font-size:28px;line-height:36px;color:#ffffff;font-weight: bold; text-align: center;" class="title"> @yield('title') </td>
                                                </tr>
                                                <tr>
                                                  <td valign="top" height="20" class="vspacer10" style="mso-line-height-rule:exactly; font-size:1px; line-height:1px;">&nbsp;</td>
                                                </tr>
                              ...
                              <tbody>
                                <tr>
                                  <td class="mobilespacer">
                                    <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <!-- 
                                 <tr><td width="90" class="hide">&nbsp;</td><td class="mobilespacer2"><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td style="font-family: 'Roboto', Arial, Helvetica, sans-serif; font-size: 12px; text-align: center; color: #0a1247; line-height: 18px;" align="center">
