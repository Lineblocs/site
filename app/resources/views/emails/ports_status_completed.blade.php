                                                        ...
                                                        <p style="margin: 0; word-break: break-word;">
                                                            <span>
                                                                <h5 style="font-size: 28px;">Hello {{$user->getName()}},</h5>
                                                                    <p>We are emailing you to let you know that your port request for number {{$port->number}} was successfully completed. you can now use this number in lineblocs user portal.  </p>
