...
<!-- ./ tabs -->
@if (isset($numberinventory))
{!! Form::model($numberinventory, array('url' => url('admin/numberinventory') . '/' . $numberinventory->id, 'method' => 'put', 'class' => 'bf', 'files'=> true)) !!}
@else
{!! Form::open(array('url' => url('admin/numberinventory'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
@endif
        <!-- Tabs Content -->
<div class="tab-content">
    ...
    <div class="tab-pane active" id="tab-general">
        <div class="form-group  {{ $errors->has('number') ? 'has-error' : '' }}">
            {!! Form::label('number', trans("admin/numberinventories.number"), array('class' => 'control-label')) !!}
            <div class="controls">
        ...
        <div class="form-group  {{ $errors->has('api_number') ? 'has-error' : '' }}">
            {!! Form::label('api_number', trans("admin/numberinventories.api_number"), array('class' => 'control-label')) !!}
            <div class="controls">
        ...
        <div class="form-group  {{ $errors->has('country') ? 'has-error' : '' }}">
            {!! Form::label('country', trans("admin/numberinventories.country"), array('class' => 'control-label')) !!}
            <div class="controls">
        ...
        <div class="form-group  {{ $errors->has('region') ? 'has-error' : '' }}">
            {!! Form::label('region', trans("admin/numberinventories.region"), array('class' => 'control-label')) !!}
            <div class="controls">
        ...
        <div class="form-group  {{ $errors->has('monthly_cost') ? 'has-error' : '' }}">
            {!! Form::label('monthly_cost', trans("admin/numberinventories.monthly_cost"), array('class' => 'control-label')) !!}
            <div class="controls">
        ...
        <div class="form-group  {{ $errors->has('setup_cost') ? 'has-error' : '' }}">
            {!! Form::label('setup_cost', trans("admin/numberinventories.setup_cost"), array('class' => 'control-label')) !!}
            <div class="controls">
        ...
        <div class="form-group  {{ $errors->has('routed_server') ? 'has-error' : '' }}">
            {!! Form::label('routed_server', trans("admin/numberinventories.routed_server"), array('class' => 'control-label')) !!}
            <div class="controls">
        ...
        <div class="form-group  {{ $errors->has('provider_id') ? 'has-error' : '' }}">
            ...
            {!! Form::label('provider_id', trans("admin/numberinventories.provider"), array('class' => 'control-label')) !!}
            <div class="controls">
