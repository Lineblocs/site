...
@section('content')
    ...
    @if (isset($server))
        {!! Form::model($server, [
            'url' => url('admin/router/' . $router->id . '/edit_server/' . $server->id),
            'method' => 'put',
            'class' => 'bf',
            'files' => true,
        ]) !!}
    @else
        {!! Form::open([
            'url' => url('admin/router/' . $router->id . '/add_server'),
            'method' => 'post',
            'class' => 'bf',
            'files' => true,
        ]) !!}
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="tab-general">
            ...
            <div class="form-group  {{ $errors->has('server_id') ? 'has-error' : '' }}">
                {!! Form::label('server_id', trans('admin/siprouters.server'), ['class' => 'control-label']) !!}
                <div class="controls">
