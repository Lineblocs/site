...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="tab-general">
        ...
        <div class="form-group  {{ $errors->has('local_number_monthly') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('sms_send_via_local_number', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('local_number_monthly') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('sms_receive_via_local_number', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('toll_free_number_monthly') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('sms_send_via_toll_free_number', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('toll_free_number_monthly') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('sms_receive_via_toll_free_number', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('short_code_monthly') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('sms_send_via_short_code', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('short_code_monthly') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('sms_receive_via_short_code', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('pstn_calls') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('pstn_calls', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('receive_calls_on_local_number') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('receive_calls_on_local_number', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('webrtc_calling_rates') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('webrtc_calling_rates', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('call_recordings') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('call_recordings', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('call_recordings_storage') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('call_recordings_storage', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
        ...
        <div class="form-group  {{ $errors->has('conference_calls') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::number('conference_calls', null, array('class' => 'form-control', 'pattern' => '[0-9]+([\.,][0-9]+)?', 'step' => '0.0001')) !!}
