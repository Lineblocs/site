            ...
            <div class="container">
                ...
                <div class="row feature">
                    <div class="col-12 col-md-6 my-auto">
                        <h3>Fully Cloud</h3>
                        <p>Get call features relevant to your business needs – from basic auto attendants to completely
                            customizable call flows that include video conferencing, CRM integrations, and more.</p>
                    </div>
                    <div class="col-12 col-md-6 my-auto">
                ...
                <div class="row feature">
                    ...
                    <div class="col-12 col-md-6 my-auto">
                        ...
                        <p>Stay up to date with a low-code solution that allows you to create highly customizable calling
                            workflows including automations, and third party integrations at ease.</p>
                    </div>
                </div>
                <div class="row feature">
                    <div class="col-12 col-md-6 my-auto">
